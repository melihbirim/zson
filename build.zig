...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zson" is the name you will use in your source code to
                // import this module (e.g. `@import("zson")`). The name is
    ...
    // Link against libc for POSIX regex and other C standard library features
    exe.linkLibC();
    ...
    const example_parallel = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("examples/example_parallel.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "zson", .module = mod },
